                ...
                <div class="card-footer">
                  <div class="row">
                    <div class="col-md-4 offset-4">
                      <button type="button" class="btn btn-flat btn-info btnWidth" @click.prevent="setEditarUsuario" v-loading.fullscreen.lock="fullscreenLoading">Editar</button>
...
export default {
  data(){
    ...
    methods: { 
        ...
        getRolByUsuario(){
          this.fullscreenLoading = true;
        var url = '/administracion/usuario/getListarRoles'
        axios.get(url, {
          params: {
            'nIdUsuario' : this.fillEditarUsuario.nIdUsuario
          }
