                            ...
                            <div class="col-md-5">
                                <div class="card card-info">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="button" class="btn btn-flat btn-info btnWidth" @click.prevent="setRegistrarPermisosByUsuario" v-loading.fullscreen.lock="fullscreenLoading">Registrar</button>
    ...
    export default {
        ...
        methods: {
            ...
            getListarPermisosByUsuarioAsignado(){
                var ruta = '/administracion/usuario/getListarPermisosByUsuarioAsignado'
                axios.get(ruta, {
                    params: {
            ...
            getListarPermisosByRolAsignado(){
                ...
                axios.get(ruta, {
                    ...
                    this.listPermisosByRolAsignado2 = response.data;
                })
            },
            getRolByUsuario(){
