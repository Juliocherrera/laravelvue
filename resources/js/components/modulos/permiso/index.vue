          ...
          <div class="card-header">
            <div class="card-tools">
              <router-link class="btn btn-info btn-sm" :to="'/permiso/crear'">
                <i class="fas fa-plus-square text-white"></i> Nuevo Permiso
              </router-link>
            </div>
          </div>
          <div class="card-body">
                ...
                <div class="card-footer">
                  <div class="row">
                    <div class="col-md-4 offset-4">
                      <button type="button" class="btn btn-flat btn-info btnWidth" @click.prevent="getListarPermisos" v-loading.fullscreen.lock="fullscreenLoading">Buscar</button>
              ...
              <div class="card card-info">
                ...
                <div class="card-body table-responsive">
                  ...
                  <table class="table table-hover table-head-fixed text-nowrap projects">
                    ...
                    <tbody>
                      <tr class="letraF" v-for="(item, index) in listarPermisosPaginated" :key="index">
                       
                        <td v-text="item.name"></td>
                        <td v-text="item.slug"></td>
                         <td>
                          <router-link class="btn btn-flatbtn-flat btn-info btn-sm rounded" :to="{name:'permiso.editar', params:{id: item.id}}">
